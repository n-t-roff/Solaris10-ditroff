...
int localize()
{
	extern int wdbindf(wchar_t wc1, wchar_t wc2, int type);
	extern wchar_t * wddelim(wchar_t wc1, wchar_t wc2, int type);
	char	*codeset;
...
/* from wdresolve.c */
int wdbindf(wchar_t wc1, wchar_t wc2, int type) {
	return (6);
}

wchar_t *wddelim(wchar_t wc1, wchar_t wc2, int type) {
	return ((wchar_t *)L" ");
}
